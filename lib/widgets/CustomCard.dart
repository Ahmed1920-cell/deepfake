            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  !IsEdit
                      ? TextWidget(
                        text: widget.info.name.length > 15 ? "${widget.info.name.substring(0, 15)}..." : widget.info.name,
                        size: 17,
                  ...
                  TextWidget(text: DateFormat.yMMMEd().format(widget.info.date), size: 16),
                ],
              ),
            ),
            Spacer(),
                    ...
                    if(IsEdit){
                      if(form_key.currentState!.validate()){
                        await BlocProvider.of<HomeCubit>(
                          context,
                        ).Update(DeepModel(video_path: widget.info.video_path, name: edit.text, result: widget.info.result, date: widget.info.date),widget.index);
